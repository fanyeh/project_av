  ...
  render() {
    return (
      <div className="flex flex-column mb5">
        <Intro
          header="avana"
          subtitle="A brand new Agency."
          description="This is the story of Avana, a minimal Bootstrap template for creative agency."
          childrenStyle="pl3-l"
        >
        ...
        <FlexBox>
          <FlexColumn className="w-50-l w-100 pr3-l">
          ...
          <FlexColumn className="w-50-l w-100 pl3-l">
